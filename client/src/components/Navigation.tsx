...
const Navigation: React.FC = () => {
  ...
  //  A  hook to select the wallet state from the Redux store
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (
      ...
      // Once the metamask wallet has been connect, it dispatches an action to the store.
      dispatch({
        type: Actions.AccountInitialization,
        payload: {
          accounts: metamaskWallet.accounts,
          chains: metamaskWallet.chains,
        },
      });
    }
  }, []);
